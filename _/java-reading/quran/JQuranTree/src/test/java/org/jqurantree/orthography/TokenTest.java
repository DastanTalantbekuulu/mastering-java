...
public class TokenTest {
	...
	public void TestChapter1Verse1() {
		...
		// Get tokens.
		Iterator<Token> tokens = Quran.getAya(1, 1).getTokens().iterator();
	...
	public void TestChapter3Verse17() {
		...
		// Get tokens.
		Iterator<Token> tokens = Quran.getAya(3, 17).getTokens()
				.iterator();
	...
	public void TestChapter38Verse1() {
		...
		// Get tokens.
		Iterator<Token> tokens = Quran.getAya(38, 1).getTokens()
				.iterator();
	...
	public void TestChapter81Verse2() {
		...
		// Get tokens.
		Iterator<Token> tokens = Quran.getAya(81, 2).getTokens()
				.iterator();
	...
	public void TestChapter114Verse1() {
		...
		// Get tokens.
		Iterator<Token> tokens = Quran.getAya(114, 1).getTokens()
				.iterator();
