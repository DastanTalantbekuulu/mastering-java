...
public class Vertex {
    ...
    private Vertex(Vertex parent, int dir, Coordinates coordinates, Type type) {
        ...
        // ========================================================
        // else {
        // this.type = AreaType.getInstance();
        // }
        // ========================================================
    }
    ...
    public static Vertex set(Coordinates coordinates, Type type) {
        if (INSTANCE == null) {
    ...
    public Vertex get(int direction) {
        return (direction == 1 && top != null) ? top
                : (direction == 2 && right != null) ? right
                        : (direction == 3 && bottom != null) ? bottom
                                : (direction == 4 && left != null) ? left
                                        : null;
    }
