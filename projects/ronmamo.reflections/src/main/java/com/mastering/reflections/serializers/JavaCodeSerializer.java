...
/** source code serialization for {@link com.mastering.reflections.Reflections} <pre>{@code reflections.save(file, new JavaCodeSerializer())}</pre>
 ...
 * <pre>{@code MyTestModelStore.com.mastering.reflections.TestModel$C1.methods.m1.class}</pre>
 * <p>depends on {@link com.mastering.reflections.scanners.TypeElementsScanner} configured
 */
