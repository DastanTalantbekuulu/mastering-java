...
import static com.mastering.reflections.MoreTestsModel.*;
import static com.mastering.reflections.ReflectionUtils.Annotations;
import static com.mastering.reflections.ReflectionUtils.SuperTypes;
import static com.mastering.reflections.ReflectionUtilsTest.toStringSorted;
import static com.mastering.reflections.ReflectionsTest.equalTo;
import static com.mastering.reflections.scanners.Scanners.Resources;
...
public class MoreTests {
    ...
    public void test_custom_url_class_loader() throws MalformedURLException {
        ...
        assertEquals(toStringSorted(reflections.getSubTypesOf(TestModel.C1.class)),
                "[class another.project.AnotherTestModel$C2, " +
                        "class com.mastering.reflections.TestModel$C2, " +
                        "class com.mastering.reflections.TestModel$C3, " +
                        "class com.mastering.reflections.TestModel$C5]");
    }
    ...
    public void test_reflection_utils_with_custom_loader() throws MalformedURLException, ClassNotFoundException {
        ...
        assertEquals(toStringSorted(ReflectionUtils.get(SuperTypes.of(aClass), t -> !Object.class.equals(t))),
                "[class com.mastering.reflections.TestModel$C1, " +
                        "interface com.mastering.reflections.TestModel$I1, " +
                        "interface com.mastering.reflections.TestModel$I2]");
    }
