...
public class NameHelperTest implements NameHelper {
	...
	public void testMethodExt() throws NoSuchMethodException {
		...
		Member lambda = forMember("com.mastering.reflections.UsageTestModel$C2.lambda$useLambda$0(com.mastering.reflections.UsageTestModel$C2)");
		...
		Member anonymous = forMember("com.mastering.reflections.UsageTestModel$C2$1.applyAsDouble(com.mastering.reflections.UsageTestModel$C2)");
