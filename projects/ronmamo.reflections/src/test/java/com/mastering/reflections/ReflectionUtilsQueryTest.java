...
import com.mastering.reflections.util.AnnotationMergeCollector;
...
import static com.mastering.reflections.ReflectionUtils.*;
import static com.mastering.reflections.ReflectionsQueryTest.equalTo;
import static com.mastering.reflections.TestModel.*;
import static com.mastering.reflections.scanners.Scanners.MethodsAnnotated;
import static com.mastering.reflections.scanners.Scanners.TypesAnnotated;
	...
	public void nestedQuery() {
		Set<Class<? extends Annotation>> annotations =
			get(AnnotationTypes.of(
					Methods.of(C4.class))
				.filter(withNamePrefix("com.mastering.reflections")));
