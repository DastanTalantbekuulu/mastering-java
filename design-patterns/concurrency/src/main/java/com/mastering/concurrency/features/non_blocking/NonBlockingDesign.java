package com.mastering.concurrency.features.non_blocking;
...
public class NonBlockingDesign {
    ...
    private final AtomicReference<Object> value = new AtomicReference<>(new Object());
    ...
    public void modifyValue() {
         ...
         * structure, this means that in the meantime some thread changed it. The loop
