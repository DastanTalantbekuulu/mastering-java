...
public class OSToolConfiguration {
    ...
    private final Lock lockExecutorCommands = new ReentrantLock();
    private final Lock lockToolName = new ReentrantLock();
    private final Lock lockUser = new ReentrantLock();
    private final Lock lockPassword = new ReentrantLock();
